  ...
  return (
    <div className="app">
      <header className="header">
        <div>
          <h1 className="title">Metsa kalkulaator</h1>
          <p className="subtitle">
            Uuri, kui palju puitu mets aja jooksul kasvatab ja millal on kõige
            tulusam see maha võtta. Liiguta liugureid — vali puuliik, kasvukoht,
            raievanus ja puiduhinnad — ning vaata, kuidas tulu muutub.
          </p>
        </div>
